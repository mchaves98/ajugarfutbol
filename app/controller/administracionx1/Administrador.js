Ext.define('AJugarFutbol.controller.administracionx1.Administrador', {
...
//==========================================================================================================================
    ...
    olvidoPws: function() {
        ...
        var view = Ext.create('AJugarFutbol.view.administracionx1.OlvidoPws');
        view.show();
...
//==========================================================================================================================
    ...
    ingresar: function(button) {
       ...
       var successAjaxFn = function(response, request) {  
           ...
           objx = objx[0];            
           objx.setValue('<center><div style="font-size:20px;width:865px;"><b>Sistema de Seguimiento de Clientes - JSoluciones, S.A.</b></div></center>');
