Ext.define('AJugarFutbol.view.administrador.ViewportADM', {
                    ...
                    dockedItems: [
                        {                           
                            ...
                            html:'<div style="margin-left:22px;margin-bottom:5px;margin-top:10px;"><iframe src="http://www.facebook.com/plugins/like.php?href=http://www.facebook.com/ajugarfut" scrolling="no" frameborder="0" style="height:25px;width:77px;" allowTransparency="true"></iframe></div>'+                                 
                                // '<div class="fb-like" style="margin-left:25px;margin-bottom:5px;margin-top:5px;width:40px;height:60px;" data-href="http://www.facebook.com/ajugarfut" data-send="false" data-layout="box_count" data-width="10" data-show-faces="false" data-font="tahoma"></div>'+
