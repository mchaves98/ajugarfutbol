Ext.define('AJugarFutbol.view.administrador.CalenReservaAdm' ,{
                    ...
                    items: [
                        {
                            ...
                            modoReservacion:'',
                            margin: 5,
                            value: '<span style="font-size:15px;">Control de Canchas:<span>'
                        },
                        {
                            xtype: 'combobox',
                            id: 'cmbCanchas',
                        ...
                        },
                        {
                            ...
                            style:'margin-left:5px;margin-top:5px;',
                            fieldLabel: '<span style="font-size:15px;">Fecha Espec&iacute;ifica</span>',
